(() => {
  ...
  function boothScrollAnimation() {
    ...
    let sectionPin = ScrollTrigger2.create({
    ...
    let boothPin = ScrollTrigger2.create({
      trigger: imageLayer,
      pin: true,
      start: "top top",
      end: () => {
  ...
  function customCursorAnimation() {
    ...
    let xTo = gsapWithCSS.quickTo(cursor, "x", { duration: 0.1, ease: "power3" }), yTo = gsapWithCSS.quickTo(cursor, "y", { duration: 0.1, ease: "power3" });
  ...
  function usageHoverAnimation() {
    ...
    headings.forEach((heading, index) => {
      ...
      heading.addEventListener("mouseout", () => {
        ...
        if (image) {
          gsapWithCSS.to(image, { autoAlpha: 0, duration: 0.2 });
        }
      });
    });
  }
  ...
  function homeHeroSlides() {
    ...
    swiper.on("slideChangeTransitionStart", function(e) {
      ...
      const totalRealSlides = swiper.slides.length / swiper.loopedSlides;
