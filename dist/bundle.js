...
<text x="50%" y="50%" style="fill:#fff" text-anchor="middle" font-size="50" dominant-baseline="middle" font-family="roboto,arial,sans-serif">${count}</text>
  ...
  function boothSoundCompare() {
    ...
    const environmentButtons = document.querySelectorAll("[data-sound-environment]");
    const environmentActiveBg = document.querySelector("[data-sound-active-environment]");
